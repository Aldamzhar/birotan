...
@include('header')
            <section class="content-section">
                ...
                <div class="content-box box3">
                    ...
                    <p>Ғылыми жобаның бағдарламалық қамтылымын кәсіби мамандармен бірлесіп жасауға қатысқан Назарбаев университетінің магистранттары Бегім Құтым мен Алдамжар Киікбаевқа, басқа да кеңесші инженерлерге алғыс білдіреміз.</p>
                </div>
            </section>
</body>

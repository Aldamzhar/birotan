...
<footer class="footer">
    ...
    <div class="footer-section-second">
        ...
        <p>
            <a href="{{Storage::disk('public')->url('TipTop_Информация_для_размещения_на_сайте_5_02_2025.docx')}}"
               target="_blank">
                TipTop Информация для размещения на сайте
            </a><br>
            <a href="{{Storage::disk('public')->url('проект_Договора_оферты_и_Политика_конфиденциальности_5_02_2025.docx')}}"
               target="_blank">
                Проект Договора оферты и Политика конфиденциальности
            </a>
        </p>
    </div>
</footer>
